...
export class AiPlayerController {
  ...
  @ApiOperation({
    ...
    description: 'Returns a list of available AI players, optionally filtered by difficulty'
  })
  @ApiResponse({
    status: 200,
  ...
  @Get()
  async getAiPlayers(@Query('difficulty') difficulty?: string): Promise<AiPlayerDto[]> {
